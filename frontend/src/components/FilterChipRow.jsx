      ...
      {options.map((opt) => {
        ...
        return (
          <button
            ...
            className={`flex-shrink-0 text-xs font-medium px-3 py-1.5 rounded-full border transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400/40 dark:focus-visible:ring-slate-300/30 ${
              active
